...
const adminEmail = 'contact@coinmaps.info'
const adminPassword = 'hjbnudtcvficbtgh'
const mailHost = 'smtp.gmail.com'
// const logo = require("./logoQWLogo.png")
var ejs = require('ejs');
const mailPort = 587
const HOST = "coinmaps.info"
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 33px 0; background: #262a42;" align="center" valign="middle">
                                ...
                                src = 'https://${HOST}/images/Cmaps-02.png'
                                alt='${HOST}' /> </a>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="font-size: 14px; line-height: 30px; padding: 20px 0; color: #666;">
                                                    ...
                                                    <p><a style="padding: 10px 28px; background: none; text-decoration: none; border: 2px solid #262a42; color: #262a42; text-transform: uppercase; font-size: 14px;" href='${HOST}/verify/${token}'
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 33px 0; background: #262a42;" align="center" valign="middle">
                                ...
                                rel="noopener"> <img class="m_3358380767117121333m_-4368746486683527934m_-6847593570969279853CToWUd CToWUd"
                                style="border: 0; max-width: 232px;"
                                src = 'https://${HOST}/images/bosswallet.png'
                                alt='${HOST}' /> </a>
                            </td>
                        </tr>
                        <tr>
